...
It's easy to copy ([fork](https://en.wikipedia.org/wiki/Fork_(software_development)#Forking_of_free_and_open-source_software)) open source software and start making changes to the source code.
